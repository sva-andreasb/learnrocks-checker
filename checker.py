...
def get_services():
    services = []
    services.append(checkService(get_service_stub('smtp4dev (E-Mails)','fakeSMTP',f'http://{IPAddr}/smtp4dev/', 'ohne Anmeldung')))
    services.append(checkService(get_service_stub('DB2','db2')))
    services.append(checkService(get_service_stub('LogViewer','logviewer',f'http://{IPAddr}/logviewer/','ohne Anmeldung')))
    services.append(checkService(get_service_stub('Cloudbeaver (SQL)','container-cloudbeaver',f'http://{IPAddr}/cloudbeaver/','User cbadmin Pw cbadmin')))
    services.append(checkService(get_service_stub('WebSphere DMgr','websphere-dmgr',f'https://{IPAddr}/ibm/console/','User wasadmin Pw wasadmin')))
    ...
    services.append(checkService(get_service_stub('Service Portal','ibm-svcportal',f'https://{IPAddr}/portal/','Standardbenutzer')))
    return services
